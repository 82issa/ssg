...
class TestTextNode(unittest.TestCase):
    ...
    def test_eq_false22(self):
        node0 = TextNode("This is a text node", TextType.TEXT)
        node2 = TextNode("This is a text node2", TextType.TEXT)
        self.assertNotEqual(node0,node2)

    def test_eq_url(self):
        node0 = TextNode("This is a text node", TextType.TEXT,"https://www.boot.dev")
        node2 = TextNode("This is a text node", TextType.TEXT,"https://www.boot.dev")
        self.assertEqual(node0,node2)

    def test_repr(self):
        node = TextNode("This is a text node", TextType.TEXT, "http://www.boot.dev")
        self.assertEqual("TextNode(This is a text node, text, http://www.boot.dev)", repr(node))
